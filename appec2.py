...
model = tf.keras.models.load_model(
    '/home/ubuntu/Rice_Leaf/Fine_tune_Resep_cbam_BP_3th7_100_monitoring.keras',  # Đường dẫn tuyệt đối trên EC2
    custom_objects={
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port=5000)  # Cho phép truy cập từ bên ngoài
